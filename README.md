...
```bash
git clone https://github.com/AssociateView/Pixal3D-ComfyUI-860.git
cd Pixal3D-ComfyUI-860
npm install
npm start
```


ComfyUI custom nodes for [TencentARC/Pixal3D](https://github.com/AssociateView/Pixal3D-ComfyUI-860): image-to-3D generation, textured GLB export, FlashAttention 2/3 selection, manual camera control, and ComfyUI model unload support.
...
This nodepack builds on [TencentARC/Pixal3D](https://github.com/AssociateView/Pixal3D-ComfyUI-860), [Trellis.2](https://github.com/microsoft/TRELLIS.2), [Trellis](https://github.com/microsoft/TRELLIS), and [Direct3D-S2](https://github.com/DreamTechAI/Direct3D-S2).
...
<!-- Last updated: 2026-06-06 15:30:37 -->
